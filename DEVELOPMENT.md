...
```bash
git remote add encore encore://smart-kalkulator-app-gdui
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/smart-kalkulator-app-gdui/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/smart-kalkulator-app-gdui/settings/integrations/github)
